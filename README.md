...
Go to the `<root>/test/` directory, and follow the instructions in [`README.md`](./test/README.md) to run the tests.
...
> See [here](https://github.com/Kim-J-Smith/Embedded-Function/actions/workflows/benchmark.yml) for more benchmark results. Follow [`README.md`](./benchmark/README.md) to run the benchmark in your platform.
